...
// Formally, select a range (l, r) in the array A[],
// such that (0 ≤ l ≤ r < n) holds and flip the elements
// in this range to get the maximum ones in the final array.
...
// Your task is to complete the function maxOnes() which takes the array A[] and
// its size N as inputs and returns the maximum number of 1's
